...
begin
	...
	ts_euler, xs_euler, vs_euler = euler_freier_fall(x_start, v_start, -g, T_sim)
end

# ╔═╡ 8f306154-e4dd-4dd7-a6a3-43e310df71bc
begin
    plot(ts_euler, xs_euler[1:end-1])
end
...
function euler_federpendel(x0, v0, k, m, t_span; N=200)
	return 0.0, 0.0, 0.0
end
...
begin
	...
	ts_euler_feder, xs_euler_feder, vs_euler_feder = euler_federpendel(x0_feder, v0_feder, k, m, T_sim_feder, N=5000)
end
